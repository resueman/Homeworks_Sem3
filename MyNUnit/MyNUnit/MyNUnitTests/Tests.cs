...
namespace MyNUnitTests
{
    ...
    public class Tests
    {
        ...
        public void Test(string className, string testMethodName, MyNUnit.ExecutionStatus expectedStatus, string expectedMessage)
        {
        ...
        public void ZeroExecutionTimeTest(string className, string testMethodName, MyNUnit.ExecutionStatus expectedStatus, string expectedMessage)
        {
            var testsClass = testsClasses.Single(c => c.TestClassType.Name == className);
            var testResult = testsClass.TestMethods.Single(m => m.Method.Name == testMethodName).ExecutionResult;
        ...
        public void NotZeroExecutionTimeTest(string className, string testMethodName, MyNUnit.ExecutionStatus expectedStatus, string expectedMessage)
        {
            var testsClass = testsClasses.Single(c => c.TestClassType.Name == className);
            var testResult = testsClass.TestMethods.Single(m => m.Method.Name == testMethodName).ExecutionResult;
